...
def main():
    ...
    print(sht1x.calculate_dew_point(aTouple[0], aTouple[1]))
    #print(sht1x.calculate_dew_point(20, 50))
    print("Temperature: {} C Humidity: {} % Dew Point: {} C".format(aTouple[0], aTouple[1], sht1x.calculate_dew_point(aTouple[0], aTouple[1])))
